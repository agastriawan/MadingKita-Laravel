                            ...
                            @foreach ($organisasi as $org)
                                ...
                                <div class="com-md-6 col-lg-3">
                                    <div class="courses-item">
                                        <a href="/organisasi/{{ $org->id }}" class="link">
                                            <div class="courses-item-inner">
                                                <div class="img-box">
                                                    <img src="{{ asset('storage/' . $org->image) }}" alt="kursus img">
                                                </div>
                                                <h3 class="title">{{ $org->judul }}</h3>
                                                <div class="instructor">
                                                    <i class="fas fa-user-circle social-icon" style="font-size: 16px"></i>
                                                    &nbsp;
                                                    <span class="instructor-name">{{ $org->pengirim }}</span>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
