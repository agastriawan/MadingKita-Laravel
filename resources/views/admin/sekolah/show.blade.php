...
<head>
    ...
    <link rel="stylesheet" class="js-color-style" href="{{ asset('css/color/color-1.css') }}">
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="/admin/sekolah">Mading
                                Sekolah</a> </li>
                        <li class="breadcrumb-item active" aria-current="page">Detail Mading</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="course-header box">
                            <h2 class="text-capitalize">{{ $sekolahs->judul }}</h2>
                            <ul>
                                <li>Created by &nbsp; - <span><a href="#">{{ $sekolahs->created_at }}</a> </span></li>
                                <li>Last Update &nbsp;- <span><a href="#">{{ $sekolahs->updated_at }}</a></span></li>
                            </ul>
                        </div>
                        <!-- course header end -->
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="description" role="tabpanel"
                                ...
                                <div class="deskripsi box">
                                    <h3 class="text-capitalize mb-4"> {{ $sekolahs->judul }} </h3>
                                ...
                                <div class="contact box">
                                    ...
                                    <ul>
                                        <li><i class="fas fa-envelope social-icon"></i> &nbsp; &nbsp;
                                            <a href="">{{ $sekolahs->email }}</a>
                                        </li>
                                        <li><i class="fab fa-whatsapp social-icon"></i> &nbsp; &nbsp;
                                            <a href="">{{ $sekolahs->whatsapp }}</a>
                                        </li>
                                        <li><i class="fab fa-instagram social-icon"></i> &nbsp;
                                            &nbsp; <a href="">{{ $sekolahs->instagram }}</a></li>
                                        <li><i class="fas fa-link social-icon"></i> &nbsp;
                                            &nbsp;<a href="{{ $sekolahs->link }}">{{ $sekolahs->link }}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="course-sidebar box">
                            <div class="courses-item">
                                <div class="courses-item-inner">
                                    <img id="myImg" src="{{ asset('storage/' . $sekolahs->image) }}"" alt="
                                        {{ $sekolahs->judul }}" style="width:100%;max-width:600px">
                                    <!-- The Modal -->
