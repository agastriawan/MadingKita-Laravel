...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Tambahkan Mading Ekstrakulikuler</h1>
    </div>


    <div class="col-lg-8">
        <form method="POST" action="/admin/ekskul" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="judul" class="form-label">Judul</label>
                <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" required
                    autofocus value="{{ old('judul') }}" autocomplete="off">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('pengirim') is-invalid @enderror" id="pengirim"
                    name="pengirim" required value="{{ old('pengirim') }}" autocomplete="off">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('whatsapp') is-invalid @enderror" id="whatsapp"
                    name="whatsapp" required value="{{ old('whatsapp') }}" autocomplete="off">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('instagram') is-invalid @enderror" id="instagram"
                    name="instagram" required value="{{ old('instagram') }}" autocomplete="off">
