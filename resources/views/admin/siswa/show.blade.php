            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="/admin/siswa">Mading
                                Siswa</a> </li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="course-header box">
                            <h2 class="text-capitalize">{{ $siswas->judul }}</h2>
                            <ul>
                                <li>Created by &nbsp; - <span><a href="#">{{ $siswas->created_at }}</a> </span>
                                </li>
                                <li>Last Update &nbsp;- <span><a href="#">{{ $siswas->updated_at }}</a></span>
                                </li>
                            </ul>
                        </div>
                        <!-- course header end -->
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="description" role="tabpanel"
                                ...
                                <div class="deskripsi box">
                                    <h3 class="text-capitalize mb-4"> {{ $siswas->judul }} </h3>
                        ...
                        <div class="course-sidebar box">
                            <div class="courses-item">
                                <div class="courses-item-inner">
                                    <img id="myImg" src="{{ asset('storage/' . $siswas->image) }}"" alt="
                                        {{ $siswas->judul }}" style="width:100%;max-width:600px">
                                    <!-- The Modal -->
