            ...
            <tbody>
                @foreach ($siswa as $siswa)
                    <tr>
                        ...
                        <td>{{ $siswa->judul }}</td>
                        <td>{{ $siswa->pengirim }}</td>

                        <td>
                            <a href="/admin/siswa/{{ $siswa->id }}" class="badge bg-info"><span
                                    data-feather="eye"></span></a>

                            <a href="/admin/siswa/{{ $siswa->id }}/edit" class="badge bg-success"><span
