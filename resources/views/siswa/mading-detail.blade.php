        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="/siswa">Mading Siswa</a> </li>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="course-header box">
                        ...
                        <ul>
                            <li>Created by &nbsp; - <span><a href="#">{{ $siswas->created_at }}</a> </span></li>
                            <li>Last Update &nbsp;- <span><a href="#">{{ $siswas->updated_at }}</a></span></li>
                        </ul>
                    </div>
                    <!-- course header end -->
                            ...
                            <div class="contact box">
                                ...
                                <ul>
                                    ...
                                    <li><i class="fas fa-link social-icon"></i> &nbsp;
                                        &nbsp;<a href="{{ $siswas->link }}">{{ $siswas->link }}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
